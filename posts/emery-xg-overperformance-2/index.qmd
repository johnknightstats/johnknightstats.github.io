...
description: "Part two: Breaking down Emery by club, and looking at forwards, keepers, and game state."
format:
  html:
...
<em>Emery's attacking overperformance comes predominantly in close games. Defensively, he outperforms xG in all game states.</em>
:::
...
<em>After adjusting for team strengths, Emery's xG overperformance in attack is most prominent when trailing by one goal.</em>
:::

::: {.centered-block}
<img src="viz/emery_regression_defence.png"/>
<em>In defence, Emery's teams overperform xG when trailing by all scorelines.</em>
:::
