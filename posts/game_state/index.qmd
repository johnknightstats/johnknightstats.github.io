...
When we look at a smoothed plot of scoring rate categorised by lead, we can see that teams with a two-goal lead score at the highest rate, followed by teams with a one-goal lead:
...
There is plenty more scope to drill down in a future analysis, but this gives us a nice framework to build on.
