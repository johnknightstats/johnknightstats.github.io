...
overall_mean_2425 <- mean(ucl_2425$mean_opp_elo)
...
overall_mean_2526 <- mean(ucl_2526$mean_opp_elo)
...
```{r}
cl_pts <- read.csv("data/ucl_expected_points_vs_schedule.csv")
...
```{r}
ucl_polar <- read.csv("data/ucl_polarised_draw_extremes_summary.csv")
